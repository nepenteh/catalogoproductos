...
Esta aplicación permite gestionar un catálogo de productos, con las opciones básicas (visualización, creación, modificación y eliminación), y ha sido creada como demostración de uso de la herramienta generadora de código Duende.

El proyecto de la aplicación está realizado con Spring Boot 2.7. y Netbeans
